            ...
            _td_c.find('.td-deg').on('touchstart mousedown', function (e) {
                ...
                $(window).on('touchmove mousemove', function (e) {
                    ...
                    if (_td_input_on == true) {
                        ...
                        move = e;
                        if (_td_mobile) {
                            move = (e.originalEvent.touches && e.originalEvent.touches[0]) || move;
                        }
                        //else move = e;
