...
function createWidget(input) {
    ...
    //    picker_title = input.data('title') || '',   //MV
    ...
    ////MV
    //if (picker_modal && picker_title) {
    //    $('<div>').addClass('picker-title').text(picker_title).appendTo(picker.element);
    //}
